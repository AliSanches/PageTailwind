    ...
    >
      <div className="text-center">
        ...
        <h2 className="text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-20 tracking-wide">
          Evoluindo de forma{" "}
          <span className="bg-gradient-to-r from-blue-500 to-orange-800 text-transparent bg-clip-text">
            super eficiente
          </span>
        </h2>
      </div>
      <div className="flex flex-wrap mt-10 lg:mt-20">
        {features.map((feature, index) => (
          <div key={index} className="w-full sm:1/2 lg:w-1/3">
            <div className="flex">
              <div className="flex mx-6 h-10 w-10 p-2 bg-neutral-900 text-blue-500 justify-center items-cnter rounded-full">
                {feature.icon}
              </div>
              <div>
